...
OBJ    := Stokes5.o Irregular.o Utils.o Wavemaker.o lsgrid.o SpectralWaveData.o probes.o VTKreader.o lsgrid.o $(MAINS)
...
$(TARGETS_STATIC_OMP_ALL): EXTRA_FLAGS = -ldl -lpthread -fopenmp
