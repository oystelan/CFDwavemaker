...
CCFLAGS := -O2 -fPIC -pthread -std=c++11 -fopenmp -DSWD_enable=1 -I$(SWD_INCL) -DVTK_enable=1 -I$(VTK_INCL) -DCFDWM_VERSION=\"v$(VERSION)\" 
LDFLAGS := -L./ -L../swd/lib 
...
TARGETS_SHARED_OMP_ALL:= $(addsuffix _v$(VERSION)_openmp_vtk.so, $(TARGETS))
TARGETS_STATIC_OMP_ALL:= $(addsuffix _v$(VERSION)_openmp_vtk.a, $(TARGETS))

#TARGETS_STATIC_OMP:= $(addsuffix _openmp.a, $(TARGETS))
MAINS  := $(addsuffix .o, $(TARGETS) )
OBJ    := Stokes5.o FentonStream.o Irregular.o Utils.o Wavemaker.o lsgrid_spline.o SpectralWaveData.o probes.o VTKreader.o $(MAINS)
...
$(TARGETS_SHARED_OMP_ALL): $(OBJ)
	...
	ln -sf lib$@ $(BUILD_DIR)libCFDwavemaker_openmp_vtk.so
...
$(TARGETS_STATIC_OMP_ALL): $(OBJ)
	...
	echo "open $(BUILD_DIR)lib$@" > temp.mri
	...
	ar -M <temp.mri
	rm temp.mri
	ln -sf lib$@ $(BUILD_DIR)libCFDwavemaker_openmp_vtk.a
