...
mydll3 = cdll.LoadLibrary("../../builds/linux64/libCFDwavemaker_openmp.so")
#mydll3 = dlopen() 
...
plt.plot(time, wave_elev3,"--", label="transient")
plt.legend()
plt.grid(True)
...
plt.plot(time,umom3,':', label='u transient')
plt.plot(time,vmom3,':', label='v transient')
plt.plot(time,wmom3,':', label='w transient')
plt.legend()
plt.grid(True)
