...
mydll3 = dlopen("../../builds/linux64/libCFDwavemaker_openmp.so")  
...
plt.plot(xx, wave_elev1, label="exact")
plt.plot(xx, wave_elev2,"--", label="linear")
...
plt.show()
plt.clf()
plt.plot(xx,u1, label='u exact')
plt.plot(xx,v1, label='v exact')
plt.plot(xx,w1, label='w exact')
plt.plot(xx,u2,'--', label='u linear')
plt.plot(xx,v2,'--', label='v linear')
plt.plot(xx,w2,'--', label='w linear')
