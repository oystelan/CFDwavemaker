...
OBJ_SWD := SpectralWaveData.o lsgrid.o $(MAINS)
OBJ_VTK := VTKreader.o $(MAINS)
...
$(TARGETS_SHARED_OMP_SWD): $(OBJ) $(OBJ_SWD)
	$(CC) $(CCFLAGS) -shared -fopenmp -fPIC -o $(BUILD_DIR)lib$@ $^ ./swd/lib/libSpectralWaveData.a $(LIBS) -lgfortran $(LDFLAGS) 
	chmod 775 $(BUILD_DIR)lib$@

$(TARGETS_STATIC_OMP_SWD): EXTRA_FLAGS = -fopenmp -DSWD_enable=1
$(TARGETS_STATIC_OMP_SWD): $(OBJ_SWD)
	ar rvs -o $(BUILD_DIR)lib$@ $^ ./swd/lib/libSpectralWaveData.a
	chmod 775 $(BUILD_DIR)lib$@
