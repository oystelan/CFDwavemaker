...
OBJ    := Stokes5.o Irregular.o Utils.o Wavemaker.o sgrid.o SpectralWaveData.o $(MAINS)
DEPS   := CFDwavemaker.h Stokes5.h Irregular.h Utils.h Wavemaker.h sgrid.h spectral_wave_data.h SpectralWaveData.h
#OBJ_OMP := $(OBJ)
